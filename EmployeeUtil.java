package Ejercicio_Propuesto_05;
...
public abstract class EmployeeUtil {
    ...
    /**
     * This method returns a employees list where his last name begin with an
     * specific letter
     * 
     * @param employees
     * @param letter
    ...
    /**
     * This method returns a map with the most old employee and the most young
     * employee
     * 
     * @param employees
     * @return
    ...
    /**
     * Returns 2 employees with the best and poor salary
     * 
     * @param employees
     * @return
     */
    ...
    /**
     * Returns the same list of employees but sorted by name and lastname
     * 
     * @param employees
     * @return
     */
